function updateIframeSrc(number) {
    var iframe = document.getElementById('linkedinFrame');
    var originalSrc = iframe.src;
    var newSrc = originalSrc.replace(/urn:li:activity:\d+/, 'urn:li:activity:' + number);
